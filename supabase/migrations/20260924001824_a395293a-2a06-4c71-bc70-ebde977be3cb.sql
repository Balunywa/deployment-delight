...
declare t text;
begin
  foreach t in array array['organizations','organization_memberships','products','offerings','offering_versions',
    'infrastructure_modules','policy_packs','customers','customer_connections','environments','deployments',
    'deployment_steps','approvals','drift_findings','compliance_checks','upgrade_waves','audit_events']
  loop
  ...
  foreach t in array array['organizations','organization_memberships','products','offerings','offering_versions',
    'infrastructure_modules','policy_packs','customers','customer_connections','environments','deployments',
    'deployment_steps','approvals','drift_findings','compliance_checks','upgrade_waves']
  loop
...
-- audit events are append-only from the app
