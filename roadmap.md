...
- Platform landing zones (Landing zones area): real ALZ Library hierarchy/archetypes/policies, plain-language setup,
  pinned library versions with release diffs, generated AVM Terraform, subscription placement per offering; CI proves
  the generated config with terraform validate and alzlibtool composition.
